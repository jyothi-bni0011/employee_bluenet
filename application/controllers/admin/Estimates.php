...
//        print_r($viewfile);
//        exit();
        pdf_create($viewfile, lang('estimates') . ' # ' . $data['estimates_info']->reference_no);
    }
...
//            redirect($_SERVER['HTTP_REFERER']);
    ...
    function attach_pdf($id)
    {
        ...
        $result = pdf_create($html, lang('estimate') . '_' . $data['estimates_info']->reference_no, 1, null, true);
        return $result;
    }
