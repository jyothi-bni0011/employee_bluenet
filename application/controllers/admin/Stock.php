...
//        redirect('admin/stock/stock_history/' . $sub_category_id);
    ...
    function assign_report_pdf($start_date, $end_date)
    {
        ...
        pdf_create($viewfile, lang('stock') . ' ' . lang('report') . ' ' . strftime(config_item('date_format'), strtotime($start_date)) . ' To ' . strftime(config_item('date_format'), strtotime($end_date)));
    }
